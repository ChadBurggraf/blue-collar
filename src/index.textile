...
<notextile>
<p class="download">
	<a class="btn btn-primary btn-large" href="https://github.com/ChadBurggraf/blue-collar/BlueCollar.msi">
		<i class="icon-download-alt icon-white"></i> 
		Download installer
	</a>
	<a class="btn btn-large" href="https://github.com/ChadBurggraf/blue-collar/BlueCollar-{{ site.blueCollarVersion }}.zip">
