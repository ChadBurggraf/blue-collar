//-----------------------------------------------------------------------
// <copyright file="DeleteScheduledJobHandler.cs" company="Tasty Codes">
...
namespace BlueCollar.Dashboard
{
    ...
    /// <summary>
    /// Implements <see cref="IDashboardHandler"/> to delete a scheduled job.
    /// </summary>
    public sealed class DeleteScheduledJobHandler : DashboardHandlerBase
    {
        private long? id;
        ...
        public DeleteScheduledJobHandler(IRepositoryFactory repositoryFactory)
        ...
        public long Id
        {
            get
            {
                if (this.id == null)
                {
                    this.id = Helper.RouteIntValue(1) ?? 0;
                }
