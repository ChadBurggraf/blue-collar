//-----------------------------------------------------------------------
// <copyright file="QueuedDetailsHandler.cs" company="Tasty Codes">
...
namespace BlueCollar.Dashboard
{
    ...
    /// <summary>
    /// Implements the queued details handler.
    /// </summary>
    public sealed class QueuedDetailsHandler : JsonHandler
    {
        private long? id;

        /// <summary>
        /// Initializes a new instance of the QueuedDetailsHandler class.
        /// </summary>
        /// <param name="repositoryFactory">The repository factory to use.</param>
        public QueuedDetailsHandler(IRepositoryFactory repositoryFactory)
